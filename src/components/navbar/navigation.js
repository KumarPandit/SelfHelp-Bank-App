        ...
        <div className={classes.root}>
            <AppBar className={classes.navColor}>
                <Toolbar>
                    ...
                    <Typography variant="h5" className={classes.title}>Dhukuti</Typography>
                    <Button size="large" color="inherit">Feed</Button>
                    <Button size="large" color="inherit">Signup</Button>
